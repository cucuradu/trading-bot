---
description: Friday weekly review — stats, grade, optional strategy adjustments
---

Local run of the Friday weekly review. Resolve today's date: `DATE=$(date +%Y-%m-%d)`.
...
STEP 3d — **Themes this week** (Gemini, free; one synthesis call):
