...
- This is the heaviest routine (reads full week of logs). Be deliberate.
- Max 2 Gemini queries (S&P 500 week return + optional macro context).
- If session has consumed >50k tokens before STEP 6, skip non-critical bullets and commit.
...
STEP 5 — If a rule needs to change (proven out for 2+ weeks, or failed badly), also update
memory/TRADING-STRATEGY.md and call out the change in the review.
